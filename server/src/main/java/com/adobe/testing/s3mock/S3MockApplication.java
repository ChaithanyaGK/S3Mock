...
//
//  /**
//   * Property name for passing a comma separated list of buckets that are to be created at
//  startup.
//   */
...
//
//  /**
//   * Property name for passing the HTTP port to use. Defaults to  {@value DEFAULT_HTTP_PORT}.
//  If set
